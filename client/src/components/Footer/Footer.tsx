...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'Instagram',
      url: 'https://instagram.com/nomadconnect',
      icon: (
    ...
    {
      name: 'YouTube',
      url: 'https://youtube.com/@nomadconnect',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className={styles.socialIcon}>
    ...
    {
      name: 'TikTok',
      url: 'https://tiktok.com/@nomadconnect',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className={styles.socialIcon}>
        ...
        <div className={styles.footerContent}>
          ...
          <div className={styles.brandSection}>
            <Link to="/" className={styles.footerLogo}>
              ...
              <span className={styles.logoText}>Nomad Connect</span>
            </Link>
